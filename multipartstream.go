...
// ContentType returns an HTTP Content-Type header value according to multipart/form-data
// with the generated boundary by NewMultipartStream.
...
// FormField adds a new form field to current multipart/form-data body.
...
// FormFile adds a new form file field in current multipart/form-data body. It panics
// if `r` is nil. The returned error, if there is one, will be related with mime type parsing
// failures.
...
// Done inserts trailling boundary signaling the end of the multipart/form-data body
// request.
